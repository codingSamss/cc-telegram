...
COMMAND_MENU_SPECS: tuple[MenuCommandSpec, ...] = (
    ...
    MenuCommandSpec("context", "Show session context"),
    MenuCommandSpec("status", "Show session status (Codex style)"),
    MenuCommandSpec("engine", "Switch CLI engine (claude/codex)"),
    MenuCommandSpec("cancel", "Cancel the current running task"),
    MenuCommandSpec("model", "View or switch Claude model"),
    MenuCommandSpec("codexdiag", "Diagnose Codex MCP status"),
